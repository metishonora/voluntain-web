...
- 21년 하계 산학 기간에 참여한 웹 개발 프로젝트입니다.
- 유튜브에 업로드 되는 강의 컨텐츠를 기반으로 사용 대상자에게 연속적인 강의를 제공하고, 쉽게 소통할 수 있는 환경을 제공하기 위해 제작되었습니다.
- 반응형 웹, 쿠키를 활용한 수강 기록 제공, small page depth를 염두에 두고 개발되었습니다.
